...
* @param {number} polynomial_degree
* @param {number} prime_size
* @param {string} secrets
* @param {string} public_vars
* @returns {any}
*/
export function run(program_json, network_size, polynomial_degree, prime_size, secrets, public_vars) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(program_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(secrets, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(public_vars, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        wasm.run(retptr, ptr0, len0, network_size, polynomial_degree, prime_size, ptr1, len1, ptr2, len2);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
async function __wbg_init(input, maybe_memory) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('nada_run_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
